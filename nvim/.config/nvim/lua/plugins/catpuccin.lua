...
return {
	{
		...
		config = function()
            ...
            GitSignsCurrentLineBlame = { fg = "#737aa2" },
            ...
            MsTeamsUnreadMessages = { style = { "bold"},  fg = "#94E2D5" },
						...
						DiffviewDiffDelete = { style = {}, fg = "none", bg = "#3f2d3d" },
